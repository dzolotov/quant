...
public interface Connector extends Runnable {
    ...
    String get(String transactionId, String className, String uuid, boolean async) throws JMSException;

    String get(String className, String uuid) throws JMSException;

    String unify(String transactionId, String className, String identifier, String identifierValue, boolean async) throws JMSException;
    ...
    boolean check(String transactionId, String className, String identifier, String identifierValue, boolean async) throws JMSException;

    boolean check(String className, String identifier, String identifierValue) throws JMSException;

    String specify(String transactionId, String className, String uuid, boolean async) throws JMSException;

    String specify(String className, String uuid) throws JMSException;

    void remove(String transactionId, String className, String uuid) throws JMSException;

    void remove(String className, String uuid) throws JMSException;

    void update(String transactionId, String className, String uuid, String content) throws JMSException;

    void update(String className, String uuid, String content) throws JMSException;

    String matchAll(String transactionId, String className, HashMap<String, String> filters, boolean async) throws JMSException;
